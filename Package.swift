...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.8.xcframework.zip",
			checksum: "e3926d4873e9b30b6f0e2ced98935664fc9864f7794bf934f6f00fef21f8879d"
		)
	]
)