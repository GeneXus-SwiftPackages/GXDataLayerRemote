...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-5.0.0-rc.0.xcframework.zip",
			checksum: "0f09bb2824d7edbeb87eb54632a410685f4d5f01a38a9da7401c1a2d3b57b509"
		)
	]
)