...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-4.1.0-rc.14.xcframework.zip",
			checksum: "dfc27e1689e4bff5e22500067f29dc184e23f6265a0d693f9391e905c1da517d"
		)
	]
)