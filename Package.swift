...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.27.xcframework.zip",
			checksum: "5c48f49c1a19fe2de62197e629f19e0cc8274634ec0f3c25f5b74211b4958b96"
		)
	]
)