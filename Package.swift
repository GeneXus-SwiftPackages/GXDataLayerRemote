...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.3.6.xcframework.zip",
			checksum: "839a512c745a5ad4616a0499b899f820fe3542e131a3032034aacf5363a9c5a7"
		)
	]
)