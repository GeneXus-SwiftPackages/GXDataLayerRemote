...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.3.xcframework.zip",
			checksum: "377bdcceded34ac896f19f6baa494e0919c6285c2414acec887aeaf14e735731"
		)
	]
)