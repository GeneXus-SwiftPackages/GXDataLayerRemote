...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.6.0-beta.0.xcframework.zip",
			checksum: "e5758a74855c11386f4e36f8b5fc0a9f4833adfc7aadc3151056e3f37bad15bb"
		)
	]
)