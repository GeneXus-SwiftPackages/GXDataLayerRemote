...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.2.2.xcframework.zip",
			checksum: "e0a344e9fd442368d2ce11f7d0d95b7d73e5deda3ecde99f25155b080949e151"
		)
	]
)