...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.1.0-beta.24.xcframework.zip",
			checksum: "e02558896228f3ad43dca82f216e7f245de4169ed34cf69c6fba753f93f385f1"
		)
	]
)