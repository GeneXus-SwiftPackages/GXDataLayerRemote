...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.27.xcframework.zip",
			checksum: "9c153f43c72b64cc3969065f7658cbed9d58b62adb8c7105051068d531bbe045"
		)
	]
)