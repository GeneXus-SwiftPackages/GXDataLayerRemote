...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.33.xcframework.zip",
			checksum: "fd4593c05ab51125a2539f09291c3d076d665a741fc37184fb96f68fce04cb60"
		)
	]
)