...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-3.1.0.xcframework.zip",
			checksum: "0b9451fbffcfe84f65166d9b7561ddb240d0b1f1e74e5fa886c986148e128201"
		)
	]
)