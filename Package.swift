...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.12.xcframework.zip",
			checksum: "fe155aebd7f60462bff62093ca7fa45533b0890e16e67d66db7468f64b2b3112"
		)
	]
)