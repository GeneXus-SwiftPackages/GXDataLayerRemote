...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230601044120.xcframework.zip",
			checksum: "6fd4cde3ed7f8c6b0320bdeea516d82d2f0915793b5c1c97adec10aae439af9c"
		)
	]
)