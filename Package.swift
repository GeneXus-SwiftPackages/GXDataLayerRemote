...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.41.xcframework.zip",
			checksum: "21aabaa77e4e895808e2e76ae475cb198bd40448951c40e032d316a5fc46ddfd"
		)
	]
)