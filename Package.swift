...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.3.0-rc.13.xcframework.zip",
			checksum: "d874c7e4499a2d6ab8d148552a506eee2d33b34a892a045ba6689e0e8c0d77cd"
		)
	]
)