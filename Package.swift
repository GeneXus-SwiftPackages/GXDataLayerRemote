...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.4.0-rc.1.xcframework.zip",
			checksum: "4fae9f3b684c64608cbd504a887af90c88808a0bbd325559dc5812221fe8b74b"
		)
	]
)