...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.29.xcframework.zip",
			checksum: "5eaab1a6fc377f665830410ba88ad836abd031eb81a819826d5b0978426322a4"
		)
	]
)