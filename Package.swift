...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "4a15ff12e05ccef5de20be4c222f5abcdcb1a166101ea3915bf91369094f721c"
		)
	]
)