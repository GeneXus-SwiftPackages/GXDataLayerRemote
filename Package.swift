...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.5.xcframework.zip",
			checksum: "795b6ff92536bd9d5df7e3744ff724409f88c2e171e4aa8d82b24cb4be72e7cc"
		)
	]
)