...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.5.xcframework.zip",
			checksum: "d8e6383a7eb046ca82347dfd854e780fb790dcf3f172820c0f41b4daf3f2eba1"
		)
	]
)