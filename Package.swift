...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.31.xcframework.zip",
			checksum: "f29445d36a9b51018c939886743d1cbd16de0e327faa8e578da383db3ba4bdda"
		)
	]
)