...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.2.0-beta.15.xcframework.zip",
			checksum: "146628947f92dcea0e2829f6cb5b828f91c9b5160f7fbdac44572d064291d4f2"
		)
	]
)