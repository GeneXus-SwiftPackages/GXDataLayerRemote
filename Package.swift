...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-2.1.0.xcframework.zip",
			checksum: "64f64e5eed55b375bbf212c4260bea26d82997a8c73eea44f781d02b913785e5"
		)
	]
)