...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.14.xcframework.zip",
			checksum: "b4e2a87108209a0064b0fcbd9edd44caef065fecbc564533984cc11f9c3819a6"
		)
	]
)