...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-3.1.0-rc.3.xcframework.zip",
			checksum: "23afc040dc8b5f64660d7000642cfd63a33d46cc73116cf3bdb3660236ded5fb"
		)
	]
)