...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "0f606d623b4ed9db7e896deaa8bc791e7c8a26fed6bd4dc63b1ee5e7970ae310"
		)
	]
)