...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-2.1.0-rc.23.xcframework.zip",
			checksum: "5c25f3826546befafcf4daefa77abf2dc8ded7034b21b3ebb0390dbe76ed1144"
		)
	]
)