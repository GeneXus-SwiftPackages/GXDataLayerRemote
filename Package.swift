...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.1.0-beta.26.xcframework.zip",
			checksum: "cada02c4e1da2c25ac37012ad78dd46bfc623bf8c09d55f896ecddf372906cbf"
		)
	]
)