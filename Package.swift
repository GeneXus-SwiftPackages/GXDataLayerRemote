...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.6.0-beta.3.xcframework.zip",
			checksum: "f740ef60510836f180eb98c0bbac057ddd5f5ec38b292b13cbecb600846fe2dc"
		)
	]
)