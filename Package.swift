...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.1.0-beta.11.xcframework.zip",
			checksum: "3481ff8f9f2d7db9ba041433a01586151032bdd7bf2551c325657d67749154c1"
		)
	]
)