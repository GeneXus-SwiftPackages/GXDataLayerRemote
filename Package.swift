...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.2.0-beta.20.xcframework.zip",
			checksum: "18a9d72a61351b9ef728e4e883ff2b12b5d7246a3fb1fc8c75bcbd9e8e288904"
		)
	]
)