...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.23.xcframework.zip",
			checksum: "acdc4df94889c79b7e5797dc723c026e0f23e82279367c7e5941efafcbfb7b5e"
		)
	]
)