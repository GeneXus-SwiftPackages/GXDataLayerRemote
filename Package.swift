...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.0.0-beta.48.xcframework.zip",
			checksum: "d55dceea348f1a508d1cfd6087752ebbf0252695700d5c3c03dec02dfe8df80d"
		)
	]
)