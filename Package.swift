...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-2.0.0-rc.36.xcframework.zip",
			checksum: "a07f4735434fc3d98326258ab7d391a8532747923960403dc80d47384ea235ba"
		)
	]
)