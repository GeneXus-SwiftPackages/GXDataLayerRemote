...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.16.xcframework.zip",
			checksum: "b78532d5008b7c1d72f924b8cc2feededf1f5c7dc4e6472cb56c561d421aef81"
		)
	]
)