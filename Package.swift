...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.5.xcframework.zip",
			checksum: "28ba5af17b5fde176657e0e2e06cf8d3bdbea3d3942184970c17a2e388dbc6c8"
		)
	]
)