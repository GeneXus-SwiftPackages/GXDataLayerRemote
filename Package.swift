...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.14.xcframework.zip",
			checksum: "156b6d961080e627be57bdc218f58551f4467fc494a18d86687a28dac6609f6b"
		)
	]
)