...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-3.1.0-rc.8.xcframework.zip",
			checksum: "a5e273989fdafd7ace5df03cd52009bdd6c71789057d5b66d725a4cab43aa319"
		)
	]
)