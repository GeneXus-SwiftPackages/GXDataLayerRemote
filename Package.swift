...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.16.xcframework.zip",
			checksum: "1652f65b418b2cfd8a3ce7328de4f973f71f6f0ec01fa1e06eec2f226adcf084"
		)
	]
)