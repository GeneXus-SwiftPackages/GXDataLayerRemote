...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.2.0-rc.15.xcframework.zip",
			checksum: "fa1fe67dc104588a45b7570d6c7849c9f485037f1018ca6d743f9c8c86bf127c"
		)
	]
)