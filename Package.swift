...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.4.xcframework.zip",
			checksum: "481791a0e98b94c91d187f0702164b9ae2b16a17d917b92fe18cdf02522979ec"
		)
	]
)