...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230330152753.xcframework.zip",
			checksum: "eab90dfcedaf732b2549e152384d4d718bab89cf348996281e5f92a226ed7a5f"
		)
	]
)