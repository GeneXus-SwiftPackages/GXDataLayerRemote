...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.24.xcframework.zip",
			checksum: "beab51b02a8fcf7957cb8f561d7a570640c13942106b5176b013c97606a6cfaf"
		)
	]
)