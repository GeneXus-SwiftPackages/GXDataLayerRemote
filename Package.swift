...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.16.xcframework.zip",
			checksum: "f8248ca3823b1e6a4a31b191ef97da3e846ce7b3d48386b752e6216dad0dc590"
		)
	]
)