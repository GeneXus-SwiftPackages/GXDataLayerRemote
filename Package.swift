...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-3.2.0-rc.9.xcframework.zip",
			checksum: "06b114c6c0ba123fad538450a874a0ed6c7815f026fc95c066b7c213910510ed"
		)
	]
)