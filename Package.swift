...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.24.xcframework.zip",
			checksum: "f9e0db4a41d6fbee68d211689308bcb7d2b4992f619247bb15b83b0e7946e131"
		)
	]
)