...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.25.xcframework.zip",
			checksum: "2426cc9c1bbbf62909cdfce852f9f33d695abed15ee91639d2a2a8d254295a29"
		)
	]
)