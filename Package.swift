...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.1.xcframework.zip",
			checksum: "e4781994fa82cab361dd84232fca84744753535f5f0f9850ca4987441c80f363"
		)
	]
)