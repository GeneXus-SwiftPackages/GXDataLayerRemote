...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.36.xcframework.zip",
			checksum: "cb895b85715c3fcb2856fbd546d5b70431d6ffb7fc0f3326ce35875cedf16cae"
		)
	]
)