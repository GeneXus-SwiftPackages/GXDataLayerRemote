...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.7.xcframework.zip",
			checksum: "1eefe9e189b2712c1ea3c17a9d6375e893adc8879db9879fbb18b46274b45f0a"
		)
	]
)