...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.13.xcframework.zip",
			checksum: "7cd1c2ca84bc797196d477789ae50a204b9834f01d84cb33bd28da8b713a65e4"
		)
	]
)