...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.15.xcframework.zip",
			checksum: "dee18085064d40479fd90dfca1097e782ce5757a71b85418611fe629bc598dc3"
		)
	]
)