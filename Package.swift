...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.19.xcframework.zip",
			checksum: "684a4eef092c26395a42e589b7ca7cbe4a0258142079a3be33212514d917ffa4"
		)
	]
)