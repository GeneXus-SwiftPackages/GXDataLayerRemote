...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-4.0.17.xcframework.zip",
			checksum: "33ad404d6ee24e938462ca81b75e082ef26a2048b4e150cbc7a416d6089756b9"
		)
	]
)