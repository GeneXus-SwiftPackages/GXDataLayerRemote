...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.30.xcframework.zip",
			checksum: "51e48dc11794a6adb3a63f60a3cc30425f954515db96546c01863862ab9843d1"
		)
	]
)