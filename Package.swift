...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.2.0-beta.8.xcframework.zip",
			checksum: "a945efaaf300879aa196d026a8484a3194b790c1a19acb7ecd7f91ffa82274a1"
		)
	]
)