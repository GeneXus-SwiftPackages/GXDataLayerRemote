...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.27.xcframework.zip",
			checksum: "ad7d000a39e124c7ca85d387aa2034e4eb113764279eca9317095cbda1103e49"
		)
	]
)