...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.14.xcframework.zip",
			checksum: "8345fbe48824742ee31a7fc10d19b79c39d1d04bf282dc2f5652ecc4578a126c"
		)
	]
)