...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.2.0-rc.25.xcframework.zip",
			checksum: "ff790279fdab78d4eb2da85ea736fe8406ce169d1d69ae3afb2e5d396feac5f1"
		)
	]
)