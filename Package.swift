...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.1.xcframework.zip",
			checksum: "78b8b10dda565e6766887499546d0f3d13d495cf9c699f34d2068ad9590ce09c"
		)
	]
)