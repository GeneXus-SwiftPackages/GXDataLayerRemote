...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.31.xcframework.zip",
			checksum: "a547384c6af4e9e72849194f81b5a10f5839c548af55dd5b5d97ede1e03e76da"
		)
	]
)