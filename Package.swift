...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.10.xcframework.zip",
			checksum: "5cc6929a56c86cd825d804162816c6ee3a7354f67fb0da7c592856efc8dd1264"
		)
	]
)