...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.25.xcframework.zip",
			checksum: "53fcc7dc4b8679b179ab25d9545eee2663ed11981ca73862dc46d9c1badc418c"
		)
	]
)