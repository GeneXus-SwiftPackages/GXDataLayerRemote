...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.3.5.xcframework.zip",
			checksum: "ae89a7d8daef488cd2f953b0285bd59c9dc3d37388fc1e0697719a410259e7ba"
		)
	]
)