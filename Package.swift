...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-4.1.5.xcframework.zip",
			checksum: "13a779ce8d56a0886935831a93555a77844d9fbd6da29ebc82efd27f95307c18"
		)
	]
)