...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.7.xcframework.zip",
			checksum: "eb79d17ea445b60db40f1136d6e465185fee15f55c8a1d66c96a698ae3208d30"
		)
	]
)