...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.8.xcframework.zip",
			checksum: "ea98df9d75181fcc4f49a85c7a3b94f386e17d9322e356f66ad1bbdd207d2793"
		)
	]
)