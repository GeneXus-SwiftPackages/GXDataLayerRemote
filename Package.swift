...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.1.0-rc.5.xcframework.zip",
			checksum: "025aa49544fe2e92e330fb68432adcd28c974a825e00e28bcd629127ffab4b4b"
		)
	]
)