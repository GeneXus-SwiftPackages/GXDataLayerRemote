...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "e626317d4ac2e7150aa8536f2898e8d07a7050404afd8217abd7cb7e9aa8a3ed"
		)
	]
)