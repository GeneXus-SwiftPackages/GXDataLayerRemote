...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.0.0-beta.44.xcframework.zip",
			checksum: "147f45ecca61a4a5889876b7d5983beb3ab432d967a047f87844fa390c7ebffc"
		)
	]
)