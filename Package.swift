...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.9.xcframework.zip",
			checksum: "b4be619fb50eaf99645ad6124caf64cb8c29683f585c6559d19bc85bf1507da9"
		)
	]
)