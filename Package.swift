...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.20.xcframework.zip",
			checksum: "b0697d1e3c040b3df8b7541eb674862d358c248fbe7712fe7d2bfd6e44c956b9"
		)
	]
)