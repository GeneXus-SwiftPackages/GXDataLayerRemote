...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.12.xcframework.zip",
			checksum: "0155f67638310150987ed7d2e9e8daf04fea4248fc179bdca69f02c8144dba71"
		)
	]
)