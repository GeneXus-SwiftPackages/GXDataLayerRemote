...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.15.xcframework.zip",
			checksum: "dfbb37cb6388423a546db54634650a32f7912b58819c668fc0da94a099557e45"
		)
	]
)