...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.24.xcframework.zip",
			checksum: "dc0ab19b58ef450aaae067eb5bce4a0ba332f5dede23e1102bd55f85adf320a4"
		)
	]
)