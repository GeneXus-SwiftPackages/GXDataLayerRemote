...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230328171001.xcframework.zip",
			checksum: "a964bdd4aff0349915b9cd6f343269c79ff9897022f332d432189945d9f19c5e"
		)
	]
)