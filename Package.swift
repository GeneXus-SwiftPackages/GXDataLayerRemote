...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.20.xcframework.zip",
			checksum: "eb3cdf2516f0b4b401046221727462d3c863c053a4f8a69c63db6c44f5a5d073"
		)
	]
)