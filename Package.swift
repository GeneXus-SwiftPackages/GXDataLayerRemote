...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.0.0-beta.49.xcframework.zip",
			checksum: "25fced2498b7813b82061aa37fc6e7b08204d359dcf69266dbea221f418387ec"
		)
	]
)