...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-2.0.0-rc.34.xcframework.zip",
			checksum: "ac3314d970b5813784e8e53ccf128311003d609565e15efda314bc298f0877ae"
		)
	]
)