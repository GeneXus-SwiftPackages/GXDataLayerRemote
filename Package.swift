...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.2.xcframework.zip",
			checksum: "1335929bbd6949e78eb8adb3ae78221029370157a1dd673d0e168d14bdd05d8f"
		)
	]
)