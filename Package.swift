...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-2.0.18.xcframework.zip",
			checksum: "1d0227922ba5ae686347428dd2636948d34b0342d39eab96317261d530ad1e99"
		)
	]
)