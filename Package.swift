...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.5.xcframework.zip",
			checksum: "ed09361c117dc96652ebd2e0da0ee352b698982deafc0c20027dc694937b04f8"
		)
	]
)