...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta.20230714111921.xcframework.zip",
			checksum: "693944753b505aecb2428f1ef904fd7e4efddc0beb4cba9ccae4eaef115d58a6"
		)
	]
)