...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.41.xcframework.zip",
			checksum: "7f416e8fba7c37c046ddc7d70ed365f1a6fe287d8b724a14ce94154f99a2a4cb"
		)
	]
)