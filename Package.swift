...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.0.0-beta.47.xcframework.zip",
			checksum: "a145ab356455e10c080205a50e4e155b07b77d7f602c291a5116d1ed55759567"
		)
	]
)