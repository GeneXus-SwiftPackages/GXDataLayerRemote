...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230505145632.xcframework.zip",
			checksum: "812c811ce68c0c8e7f255d85b5c6ba28e1e81d7d270b54c2def7e61eee7f8ba4"
		)
	]
)