...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.1.3.xcframework.zip",
			checksum: "6ffca335e3d00fbde17d734e98e6288ac7ec8ec3ce524e53601d61cf2162136a"
		)
	]
)