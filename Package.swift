...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.3.xcframework.zip",
			checksum: "180a1162b325dd052afc6ba819ffd098ef3ea9f9aa70a6a3575dc722f232b9ee"
		)
	]
)