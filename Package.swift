...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.27.xcframework.zip",
			checksum: "2229bd12b5f13c4313dfd12eaf2ce4f6420ae5ceb54a5a4413658341c58f3223"
		)
	]
)