...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-3.1.5.xcframework.zip",
			checksum: "7f7276dc526e91145ddd2b573571c5131a82daabd48af811e6abd904d03908a8"
		)
	]
)