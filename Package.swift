...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-3.2.0.xcframework.zip",
			checksum: "4c1c6e261326901fe0e1f2c7bb475ae080cc963fe47b4a7723472fcd9070a03c"
		)
	]
)