...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.794.xcframework.zip",
			checksum: "8fc1e3360fc5fde9c839b9abb294dbde4c175a480bf3c47f2170b905a521be7e"
		)
	]
)