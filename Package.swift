...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta.20230721123914.xcframework.zip",
			checksum: "6d4c8e7c2b617d1fc19cc5e5718890de2cb303de11767fe8b580fcf82314744d"
		)
	]
)