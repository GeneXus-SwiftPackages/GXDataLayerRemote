...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.2.0-beta.17.xcframework.zip",
			checksum: "6709745ae4094ece9e67170e7b94a9362e289bd3c65e4f5ff9b81653bd103776"
		)
	]
)