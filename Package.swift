...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.1.0-beta.9.xcframework.zip",
			checksum: "1828ecb077c758194fef542455b74ba2a93dd6119bf8464341d0dc225a35b94f"
		)
	]
)