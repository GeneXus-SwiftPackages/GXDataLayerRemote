...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.22.xcframework.zip",
			checksum: "e81e3a091bb2564c7895007af6deb5c4f770ec2c04ba84513556a420fbe32e15"
		)
	]
)