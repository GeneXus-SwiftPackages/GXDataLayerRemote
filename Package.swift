...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.4.29.xcframework.zip",
			checksum: "a033465c3bb199815b8cb80b1bb82682170810e976abb003957a7b84e0adef7d"
		)
	]
)