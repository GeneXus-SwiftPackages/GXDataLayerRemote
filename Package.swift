...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.7.xcframework.zip",
			checksum: "8d2fab6643ff95dd47f4e0804252805d5cd8b27c878e99626d93f3ef8b8eee6d"
		)
	]
)