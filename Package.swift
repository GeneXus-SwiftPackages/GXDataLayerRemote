...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.33.xcframework.zip",
			checksum: "e82c31a4ff308e25a692a9c595fab4830a84eca635e7363cce85dd6d2cd052c6"
		)
	]
)