...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.17.xcframework.zip",
			checksum: "cb0eca11b7d9bbe72a7bfc0cf00a13b65887dd596a70402b17832a7298015327"
		)
	]
)