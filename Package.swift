...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.3.0-rc.7.xcframework.zip",
			checksum: "07f6d63109379e8533a5b485722a4498ebb995237f95fa8711a130f139026de6"
		)
	]
)