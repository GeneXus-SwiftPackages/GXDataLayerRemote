...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.2.0.xcframework.zip",
			checksum: "6f8efa05ac286ef0448de28a8e8e22bca3dbdcbf7337ef5ffcc615ba68da1df5"
		)
	]
)