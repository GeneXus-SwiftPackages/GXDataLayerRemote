...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.19.xcframework.zip",
			checksum: "db8bd8b189375057f2283ea6bb74f464eee3ea4dc79cfac3e7694e19b30025e0"
		)
	]
)