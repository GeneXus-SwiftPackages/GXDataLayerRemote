...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.13.xcframework.zip",
			checksum: "68d8320695398931de7678dbd1a06b4504b76c5e218d8cff15c66d8f371c1269"
		)
	]
)