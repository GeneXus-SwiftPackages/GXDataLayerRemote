...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.20.xcframework.zip",
			checksum: "80ade21cf4e178e996234dea80d6b16f569cdd064596a579e105e9f123574a8e"
		)
	]
)