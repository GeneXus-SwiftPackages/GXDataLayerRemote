...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.35.xcframework.zip",
			checksum: "cad72256627fcdd4ca42fdcb9b8231f1d13e1cadbad0a54b17cf736c5762bf8f"
		)
	]
)