...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.29.xcframework.zip",
			checksum: "614ca029a8a4650443cc00dcabb54d84089f4a3d0862351061941478e9a9c0ff"
		)
	]
)