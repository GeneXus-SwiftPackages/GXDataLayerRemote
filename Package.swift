...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-3.1.1.xcframework.zip",
			checksum: "994933f4492b451d51099d951078e86d0bf090a0b76832b55e9ab0d824cd280d"
		)
	]
)