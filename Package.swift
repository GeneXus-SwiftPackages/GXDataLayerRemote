...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.23.xcframework.zip",
			checksum: "4f9c7b05c8e368811e2dc2a1c30843997a063aa99c528fb7063ccaeaa2324b0b"
		)
	]
)