...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.8.xcframework.zip",
			checksum: "dbce56118fb4e013502ef8d07b424f10eba3072c0d6a0356ff4c7d623ecc318e"
		)
	]
)