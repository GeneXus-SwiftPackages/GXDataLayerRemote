...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.26.xcframework.zip",
			checksum: "047ca3c58e20c9bf46e71f74ae1bfaff50efcb03d27431c37733833f811e03ec"
		)
	]
)