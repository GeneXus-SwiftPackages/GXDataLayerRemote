...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.36.xcframework.zip",
			checksum: "de7be5366c8661c4a0859a3b353b12791db371176ed52b20de8830b9fa95353a"
		)
	]
)