...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.1.0-beta.23.xcframework.zip",
			checksum: "414c4dbac25318767c9fe240a94da1470ab20b34d959ec0f09616edb4af9b040"
		)
	]
)