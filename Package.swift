...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.6.0-beta.4.xcframework.zip",
			checksum: "7192233ab665d7bfa9f1cc0fbbf8d4458bf7518d93cb2e779ab45979c0c83cbc"
		)
	]
)