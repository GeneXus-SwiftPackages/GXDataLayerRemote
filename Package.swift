...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.7.xcframework.zip",
			checksum: "12fe34c870f19c6702b759ea3aae045229dfa98c2cd37e04a0aa4c2e3e5ef008"
		)
	]
)