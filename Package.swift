...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-3.0.1.xcframework.zip",
			checksum: "a40b16a99277bea46e8f9818b747bb3b7921c502aee64359362f14fc112c654b"
		)
	]
)