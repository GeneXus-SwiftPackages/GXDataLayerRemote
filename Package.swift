...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.2.1.xcframework.zip",
			checksum: "115b36491b5ba05ffd8f2c2cadc91c0269162095798ea734391b155476c729d0"
		)
	]
)