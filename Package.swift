...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.19.xcframework.zip",
			checksum: "353f7b12f90279024964b1874670169737047d2a0049a0275e0aa9ba336b1f71"
		)
	]
)