...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.11.xcframework.zip",
			checksum: "2240c2330640fab42407e7954aacac7c3692a337074d94e1b4229dd9c8e1db82"
		)
	]
)