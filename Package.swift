...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.34.xcframework.zip",
			checksum: "cced4f2c5b51ff168fc04015517388e7d903c7a5ec0b8adfde70c1df21c5c035"
		)
	]
)