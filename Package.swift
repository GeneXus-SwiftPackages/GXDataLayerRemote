...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.1.xcframework.zip",
			checksum: "04078ceb38ef5f28e578e45f13b2f4e347cb26eea74b60ada9883251bfa1f29c"
		)
	]
)