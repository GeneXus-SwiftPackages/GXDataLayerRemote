...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.0.0-beta.45.xcframework.zip",
			checksum: "38f6ce2b8e699d69ffc68a751d132d12f7279683a4de62934a5763914149c0d2"
		)
	]
)