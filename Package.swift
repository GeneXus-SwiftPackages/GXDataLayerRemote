...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230309171424.xcframework.zip",
			checksum: "575fc3c81dc3e483c13a7a15cd228e143864ade6ba1fc5217e446613c4e2d6db"
		)
	]
)