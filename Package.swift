...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.5.17.xcframework.zip",
			checksum: "133aea2ffa6712571a831c2212e2585747b1912f8f83216d2b25b9922368c43d"
		)
	]
)