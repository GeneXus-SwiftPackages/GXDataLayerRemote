...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.21.xcframework.zip",
			checksum: "9c5c3c3701e4ecf5aa7317f6e75a6298454bb6ade97cc5705116e67a4199beb7"
		)
	]
)