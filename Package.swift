...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.38.xcframework.zip",
			checksum: "1edea182d60321bbef908b0bc9bc33f003c7d13d82395608bb14e5ebabed714d"
		)
	]
)