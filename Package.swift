...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.12.xcframework.zip",
			checksum: "2cfd64d4d13d06efa53d4165e81442532e2160e4533f99b9a2d1e9e184810115"
		)
	]
)