...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.25.xcframework.zip",
			checksum: "8ec9060242cdd2bd01e0dc3cbcacfcfd18e95348717d6b5102674103ac2b3ed7"
		)
	]
)