...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.24.xcframework.zip",
			checksum: "c123155acce3f4c22aa6f6ddbb3a8a4a42767acd0900595aa27077e259f2fa62"
		)
	]
)