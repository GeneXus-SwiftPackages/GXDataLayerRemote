...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.9.xcframework.zip",
			checksum: "0b3b02ca6914b879ef7512533f177d5b6174e8a237a5b14e99f0d4dd0517e71e"
		)
	]
)