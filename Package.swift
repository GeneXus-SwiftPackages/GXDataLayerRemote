...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.1.2.xcframework.zip",
			checksum: "d1b31dd9affab7cf3fbe915fdf9e246fe43ce36b1a847a672f66fdb3b013f6f6"
		)
	]
)