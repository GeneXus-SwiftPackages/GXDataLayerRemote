...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.19.xcframework.zip",
			checksum: "2152151de81907b7017fc5bdf3fbc955fa4636abdd9b2f96dc1784bd7624d570"
		)
	]
)