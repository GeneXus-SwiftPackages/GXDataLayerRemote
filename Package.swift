...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230509202229.xcframework.zip",
			checksum: "01c7ce9193f9b795690f7ce78b5397d531da58813441998d5c55f3dbbd8620ec"
		)
	]
)