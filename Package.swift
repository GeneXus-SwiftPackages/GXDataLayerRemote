...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.11.xcframework.zip",
			checksum: "3fc26a013ee6240a0a36297ad428ec136cf07c07a44b783d6bf57ff507062678"
		)
	]
)