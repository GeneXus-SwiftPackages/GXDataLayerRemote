...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.38.xcframework.zip",
			checksum: "5599ed87169b8eca4b262955564071147f485b2a5dc835689a7e707004bbc0cb"
		)
	]
)