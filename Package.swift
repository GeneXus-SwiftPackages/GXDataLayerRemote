...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-4.0.9.xcframework.zip",
			checksum: "e98754808dfef38623566cd167372c5d08a89c4e507f275399ee27c72013cb9d"
		)
	]
)