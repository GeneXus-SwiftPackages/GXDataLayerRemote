...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.795.xcframework.zip",
			checksum: "6c733f2288b3d4a872020d1c6f92d95ce561d1bc8b55f10911cdc75789cc8cec"
		)
	]
)