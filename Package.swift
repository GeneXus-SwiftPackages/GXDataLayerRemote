...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.2.0-beta.13.xcframework.zip",
			checksum: "c972d596a4d3c160db676512ce401911fb07f8facd435a62e58cb47eb299ef28"
		)
	]
)