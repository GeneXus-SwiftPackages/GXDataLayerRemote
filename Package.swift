...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.23.xcframework.zip",
			checksum: "6b0202b4f724cba35cb786cb639960a456c1a5863a48c5cc3673f54977381861"
		)
	]
)