...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.28.xcframework.zip",
			checksum: "7fad40d80619923c2c4b1994ee42bac140a579c46086a7e648e45036a8271962"
		)
	]
)