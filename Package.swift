...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-5.0.0-beta.1.xcframework.zip",
			checksum: "e6d2d45a86f21dbb28ad291e3eb4c1ce284e0bbba6a3b3e28f405e641946efad"
		)
	]
)