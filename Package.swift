...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.10.xcframework.zip",
			checksum: "623ac37d38c8370d2409594e00fd3715ffb405169d4ef4da93c61e03d4831b19"
		)
	]
)