...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.6.xcframework.zip",
			checksum: "092bad2def9f03f8a3f9971c113f9ada879ece16d150ab4855fe25ef61537909"
		)
	]
)