...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.4.27.xcframework.zip",
			checksum: "b6feaa8ad470b33b948f39a9809a183eb8e694381f5f60297d8985a19ded5af6"
		)
	]
)