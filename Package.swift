...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.29.xcframework.zip",
			checksum: "e043cc19ecd9efedceeba8e231cd765ac976d2fd4165fd4e749eaadc24bf11d7"
		)
	]
)