...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.2.xcframework.zip",
			checksum: "a597b424c6b81bfb359ea6a542cd0057366997e271808f12f1d6aa09ec632022"
		)
	]
)