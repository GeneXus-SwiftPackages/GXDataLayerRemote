...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-4.1.0-rc.25.xcframework.zip",
			checksum: "c97e8f32f5489214c409601a506ba0f0cbb046f946929340591010559fad57c2"
		)
	]
)