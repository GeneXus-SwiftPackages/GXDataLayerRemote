...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "cf1c32a93f2fe3b380e043f5465621385ad0b578c680657b2bb5717cd5eff26a"
		)
	]
)