...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230228111720.xcframework.zip",
			checksum: "5161d7fa8a50157f5fcf6c0260139fae7c589000c004b119e78bf32f4c7a170a"
		)
	]
)