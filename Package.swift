...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.2.xcframework.zip",
			checksum: "11cfd03797882df391011c35f1ed71047d21d272a9c6e17e2874a5d8097bed79"
		)
	]
)