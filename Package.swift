...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.2.0-rc.29.xcframework.zip",
			checksum: "e98b2caf6afc83f1fa4db21ac65f452a1f8dd9177363d99a1a0fdef70958f264"
		)
	]
)