...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta.20230707201252.xcframework.zip",
			checksum: "ded46dbc7bd2cb56e2174e4ab2de4a833edaf355c1af1d1d29de406c4d05b4c1"
		)
	]
)