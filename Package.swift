...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.4.0-beta.5.xcframework.zip",
			checksum: "e799723711efccd335515bc369242d2bae838a6a4b1176d5c13a82fda9d9c1fb"
		)
	]
)