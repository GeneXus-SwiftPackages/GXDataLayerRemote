...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-2.1.0-rc.25.xcframework.zip",
			checksum: "412b66227b469c0509d591711e0c22b899e666ee1a2b674bef27d180cf685413"
		)
	]
)