...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.25.xcframework.zip",
			checksum: "fcabf3b6c2c4ba1e786d86a93bb8a1342ebe38e0ba590c1c5aac30ceaac43fc7"
		)
	]
)