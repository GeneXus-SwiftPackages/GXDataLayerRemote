...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.2.0-beta.14.xcframework.zip",
			checksum: "4c5cb7c55ec85f9289f579947f8738c571764ec5e1eb32f670077e06d8f65920"
		)
	]
)