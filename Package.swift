...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-1.4.30.xcframework.zip",
			checksum: "8a924bd1aef23ecd496bbbfc1121c09d7a507a43f82386e1a937c3e98a4b1dc6"
		)
	]
)