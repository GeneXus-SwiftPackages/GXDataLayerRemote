...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.1.0-beta.4.xcframework.zip",
			checksum: "7d5deff93853d9a887dc235c6fb280c77f5a8e0e9b6327f43682ddb049485427"
		)
	]
)