...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.21.xcframework.zip",
			checksum: "e2ca8e69a51301634eff6a97ce0a8127ee084039f20e1f8516dbd16d06235719"
		)
	]
)