...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.6.0-beta.2.xcframework.zip",
			checksum: "783fbe4bfae9b8c410d6cb169ebe7ffd9299fba840234efbc2385fe686dd54d7"
		)
	]
)