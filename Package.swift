...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.2.0-beta.3.xcframework.zip",
			checksum: "dfb8f42c6495766ebbe7bcc0a423fda71e4cce2f8fc8ac511511a97227042c71"
		)
	]
)