...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.1.0-beta.12.xcframework.zip",
			checksum: "db4a1477a481e22cd3e08ef8d6b3087b1dccfed00ee7efb70701fd7febcf8c65"
		)
	]
)