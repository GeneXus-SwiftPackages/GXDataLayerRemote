...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.1.0-beta.15.xcframework.zip",
			checksum: "0fb46165816277945a8d52a8572503616945f885fd3ee892f226c4aa253687fb"
		)
	]
)