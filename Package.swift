...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.4.xcframework.zip",
			checksum: "07e38829b84d1c147b3d70b7cb3e752c65c92ae64983afdf0d203ce24ba0a5a8"
		)
	]
)