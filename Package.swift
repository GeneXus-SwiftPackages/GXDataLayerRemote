...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.16.xcframework.zip",
			checksum: "b2c0af9bb6072eb69cefb622557055ed2aac18fa6029227f21eaa7e6cadd3a0f"
		)
	]
)