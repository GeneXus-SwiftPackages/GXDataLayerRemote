...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.5.0-beta.10.xcframework.zip",
			checksum: "daa90e144804e87101d062418b5eb1fea5da11a62f0affaf26e37f3a4c4ea717"
		)
	]
)