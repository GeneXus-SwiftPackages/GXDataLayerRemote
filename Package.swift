...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.8.xcframework.zip",
			checksum: "8ee22d148250ef7a363c02511d3da08fe2268914d4bf8e90d9837fc92c91ed55"
		)
	]
)