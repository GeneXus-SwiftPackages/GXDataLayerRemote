...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-4.1.0-beta.6.xcframework.zip",
			checksum: "d9257cfa80e502c11840c6309a67609c20b68d2e455acd24ae33f31c2bc6b8d3"
		)
	]
)