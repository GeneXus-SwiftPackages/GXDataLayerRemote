...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.13.xcframework.zip",
			checksum: "3252b913f65e2eb54855d7756387acf412753d1c997262a0162cedcf88863b76"
		)
	]
)