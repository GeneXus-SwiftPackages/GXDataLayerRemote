...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.0.0-beta.10.xcframework.zip",
			checksum: "1a30fe003c5e6ef7c8c34a1928b735afc1dd3e5aaaf3b640619330854e2a4f9f"
		)
	]
)