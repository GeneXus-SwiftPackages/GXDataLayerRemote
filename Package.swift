...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "0fe6ebdb28bc8790ee0557ccd0c7a381e7ace88355a27213fa4541cbb801b633"
		)
	]
)