...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.0.0-beta.16.xcframework.zip",
			checksum: "abdf45dffb73a38ba031ccc8d85fed39800e4ee1b0e73b5aaa8cfcedfd8627b3"
		)
	]
)