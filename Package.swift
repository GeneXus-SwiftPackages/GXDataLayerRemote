...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/releases/GXDataLayerRemote-4.1.0.xcframework.zip",
			checksum: "04b89815e980580f243024898cfa8128f25136f74f5a342657c0d07c0d78e6d7"
		)
	]
)