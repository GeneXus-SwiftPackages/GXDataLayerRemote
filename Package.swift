...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-3.2.0-beta.36.xcframework.zip",
			checksum: "6132d6df096b531cc310412599186cfcac2ca8ecb8a4159c274a3d545431f01f"
		)
	]
)