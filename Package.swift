...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.2.0-rc.36.xcframework.zip",
			checksum: "53b4f54a3c423ac15eb7be6a59a35e2ba7ae5715a38a607b6bf1fe5f04bc8970"
		)
	]
)