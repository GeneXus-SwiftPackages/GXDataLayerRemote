...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-2.2.0-beta.14.xcframework.zip",
			checksum: "97a5c89208e21e04d879e823c1610625655924fbb73e4a261feeaa291a26a09c"
		)
	]
)