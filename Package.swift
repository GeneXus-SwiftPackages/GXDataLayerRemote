...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230217024255.xcframework.zip",
			checksum: "12c16557c1f4564ccb9a802949b693f5db14531210c6e21a2abfef6b50c19096"
		)
	]
)