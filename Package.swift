...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayerRemote-1.6.0-rc.0.xcframework.zip",
			checksum: "29126d63f114554e2af6b56e4d1030d56401c78b380b2ba0ebeb4d535f0f2bb8"
		)
	]
)