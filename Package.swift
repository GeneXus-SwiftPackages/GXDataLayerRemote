...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.3.0-beta.8.xcframework.zip",
			checksum: "d1a5e0cac633fbdde47bae4f6ba0e635f7cb8b8a9b51348d8bcaf8aaafd2eab0"
		)
	]
)