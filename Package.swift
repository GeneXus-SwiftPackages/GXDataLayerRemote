...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayerRemote",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayerRemote-1.0.0-beta+20230516174834.xcframework.zip",
			checksum: "7fc0ac2df30dbbdc135adc23837dd1c10285db9b9abe9f44ee7dc7b5f6b06a57"
		)
	]
)